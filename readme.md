...
Para obtener más detalles sobre el proceso EDA se puede consultar la sección correspondiente en el [Notebook EDA, Tratamiento de Datos y Preparación](notebooks/2.EDA.ipynb)
